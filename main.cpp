...
///
/// \return             0 if the application ran successfully, otherwise an
/// error code.
///
int main(int argc, char *argv[]) {
  // create application
  QApplication app(argc, argv);
  app.setOrganizationName("IEEM_Bruchsal");
  app.setOrganizationDomain("https://www.hs-karlsruhe.de/ieem/");
  app.setApplicationName("ASTM");
