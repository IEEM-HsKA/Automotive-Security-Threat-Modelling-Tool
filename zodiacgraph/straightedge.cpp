...
StraightEdge::StraightEdge(Scene *scene, EdgeGroupInterface *group,
                           Node *fromNode, Node *toNode)
    : BaseEdge(scene), m_group(group), m_fromNode(fromNode), m_toNode(toNode),
      m_startPoint(QPointF()), m_endPoint(QPointF()) {
